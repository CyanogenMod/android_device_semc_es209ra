...
vendor/__VENDOR__/__DEVICE__/proprietary/libcamera.so:obj/lib/libcamerasemc.so \\
vendor/__VENDOR__/__DEVICE__/proprietary/libcamera.so:system/lib/libcamerasemc.so
