...
char const*const RED_LED_FILE_TRIGGER	= "/sys/class/leds/lv5219lg:rgb1:red/blink_on";
char const*const GREEN_LED_FILE_TRIGGER	= "/sys/class/leds/lv5219lg:rgb1:green/blink_on";
char const*const BLUE_LED_FILE_TRIGGER	= "/sys/class/leds/lv5219lg:rgb1:blue/blink_on";

char const*const BUTTON_BACKLIGHT_FILE	= "/sys/class/leds/lv5219lg:sled/brightness";
char const*const LCD_BACKLIGHT_FILE	= "/sys/class/leds/lv5219lg:mled/brightness";
...
static int set_light_buttons (struct light_device_t *dev, struct light_state_t const* state) {
	...
	int on = is_lit(state);
	pthread_mutex_lock(&g_lock);
	err = write_int (BUTTON_BACKLIGHT_FILE,on?1:0);
	pthread_mutex_unlock(&g_lock);
